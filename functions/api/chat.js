...
function localCanonReply(last, lead) {
  ...
  if (/price|pricing|cost|rate|trip fee|diagnostic|labor|winteriz|trip prep|seasonal/.test(q)) {
    return `Pricing: Trip fee $75 within 30 miles, then $1.50/mi each way. Labor ~$150/hr (1 hour minimum · 30-minute increments after). Winterization & trip prep: TT $175 · 5th Wheel/MH $225 (labor included; materials extra). Diagnostic $150  -  applied toward repair if you proceed. Parts quoted before install. Call or text ${phone} or Book a Service at /book-service/`;
  }
