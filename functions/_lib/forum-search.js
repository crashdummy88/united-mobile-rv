 ...
 * placeholder examples like "Victron inverter" missed real threads that
 * mention both terms without that exact adjacent phrase. Tokenize and AND
 * the terms (SQLite LIKE is case-insensitive for ASCII).
 */
